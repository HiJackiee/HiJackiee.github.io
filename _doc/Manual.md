...
```yml
# Site settings
title: HiJackiee Blog             # title of your website
SEOTitle: HiJackiee Blog          # check out docs for more detail
...
It's possible that you want the two things different. For me, my site-title is **“HiJackiee Blog”** but I want the title shows in search engine is **“黄玄的博客 | HiJackiee Blog”** which is multi-language.
